<div class="page-header d-flex justify-content-between align-items-center mb-4">
    ...
    <div><a href="<?= base_url('product/' . $product['slug']) ?>" class="btn btn-outline-primary" target="_blank">View on Site</a><a href="<?= base_url('admin/products/edit/' . $product['id']) ?>" class="btn btn-primary ms-2">Edit</a></div>
</div>
<div class="row g-4">
    <div class="col-lg-8">
