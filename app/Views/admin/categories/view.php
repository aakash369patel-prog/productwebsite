<div class="page-header d-flex justify-content-between align-items-center mb-4">
    ...
    <div><a href="<?= base_url('admin/categories/edit/' . $category['id']) ?>" class="btn btn-primary">Edit</a><a href="<?= base_url('admin/categories') ?>" class="btn btn-light ms-2">Back</a></div>
</div>
