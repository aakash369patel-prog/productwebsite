    ...
    <div class="container">
        <div class="products-toolbar">
            <form method="get" class="row g-3 align-items-end">
                <div class="col-lg-4 col-md-6">
                    ...
                    <input type="text" name="search" class="form-control" value="<?= esc($search ?? '') ?>" placeholder="Search by name...">
                </div>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <select name="category" class="form-select" onchange="if(this.value) window.location=this.value;">
                        <option value="<?= base_url('product') ?>">All Categories</option>
        ...
        <?php if (empty($products)): ?>
            <div class="empty-state text-center py-5">
                ...
                <a href="<?= base_url('product') ?>" class="btn btn-primary">View All Products</a>
            </div>
        <?php else: ?>
            <div class="row g-4">
...
<?php if (false): // Browse by category section disabled ?>
